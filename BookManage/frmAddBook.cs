...
namespace BookManage
{
    public partial class frmAddBook : Form
    {
        ...
        private void btnInsertBkDt_Click(object sender, EventArgs e)
        {
            ...
            if (Vaildate())
            {
                string sql = string.Format("insert into bookinfo values('{0}','{1}','{2}',{3},'{4}','{5}',{6})", booktype
                    , bookname, bookauthor, bookprice, bookpic, bookcontent, bookissue);
        ...
        {
            if (this.txtType.Text!=string.Empty&&this.txtName.Text!=string.Empty&&
                this.txtAuthor.Text!=string.Empty&&this.txtContent.Text!=string.Empty
                &&this.txtIssue.Text!=string.Empty&&this.txtPrice.Text!=string.Empty)
            {
                return true;
            }
            else
